    ...
    if (!Module['wasmBinary'] &&
      ...
      WebAssembly.instantiateStreaming(fetch(wasmBinaryFile, { credentials: 'same-origin' }), info)
        ...
        .catch(function(reason) {
          ...
          /*
          if(`${reason}` === "TypeError: WebAssembly: Response has unsupported MIME type 'application/octet-stream' expected 'application/wasm'") {
              Module['printErr']('falling back to fetchAndInstantiate');
              fetchAndInstantiate();
          }
          else {
